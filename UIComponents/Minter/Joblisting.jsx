        ...
        <Box>
          <VStack direction="vertical">
            ...
            <Textarea
              ...
              maxWidth="400"
              minH="200"
              placeholder="Job Description plus your address to you contact eg. 0xf7"
              onChange={(e) =>
            ...
            <Input
              maxWidth="400"
              placeholder="basic salary p/m or bio-weekly"
              mt="2"
              onChange={(e) =>
            ...
            <Input
              maxWidth="400"
              placeholder="Enter Polygon Address to Post your Offer"
              mt="2"
              onChange={(e) =>
                updateFormInput({
                  ...formInput,
            ...
            <Box maxWidth="400">
              <Text textAlign="center">Upload Company logo below</Text>
              <form>
                <Input
                  maxWidth="400"
                  mt={2}
